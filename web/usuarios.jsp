                            ...
                            <div id="tabs-2">
                                ...
                                <div class="container-fluid">
                                    ...
                                    <div class="row mt">
                                        ...
                                        <div class="col-md-4">
                                            <input placeholder="Usuario" class="form-control" type="text" name="idusuario" id="idusuario" required>
                                        </div>
                                        ...
                                        <div class=" col-md-4 " >
                                            <input placeholder="Contrase&ntilde;a" class="form-control" type="text" name="contrasenia" id="contrasenia" required>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class=" col-md-4 " >
                                            <input placeholder="Apellido Paterno" class="form-control" type="text" name="apellidopaterno" id="apellidopaterno" required>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 " >
                                            <input placeholder="Apellido Materno" class="form-control" type="text" name="apellidomaterno" id="apellidomaterno" required>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class=" col-md-4 " >
                                            <input placeholder="Tema" type="text" name="tema" id="tema" class="form-control" >
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 " >
                                            <input placeholder="Lenguaje" type="text" name="lenguaje" id="lenguaje" class="form-control">
                                        </div>
